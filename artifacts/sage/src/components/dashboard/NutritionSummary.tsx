...
export function NutritionSummary({ totals, isLoading }: NutritionSummaryProps) {
  if (isLoading) {
    return (
...
function MacroCard({ title, current, target, percent, unit, testId }: { title: string, current: number, target: number, percent: number, unit: string, testId: string }) {
  return (
